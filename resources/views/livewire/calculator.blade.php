<div>
    <div class="flex flex-col items-center">
        <div class="flex p-16 mx-auto justify-center items-center gap-4">
            ...
            <button wire:click="calculate" class="py-2 px-4 bg-indigo-500 disabled:cursor-not-allowed disabled:bg-opacity-90 rounded text-white" {{ $disabled ? 'disable' : '' }}>=</button>
        </div>
